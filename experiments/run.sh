...
# sudo -E python3 run.py --verbose --force --filter="vtatest-qk-rtl" --force pyexps/vtatest.py --repo /home/jiacma/npc/simbricks-lpn/
# sudo -E python3 run.py --verbose --filter="npb_benchmark-gem5_kvm" --force pyexps/npb_benchmark.py --repo /home/kejr/qemu/shared/simbricks-lpn/
sudo -E python3 run.py --verbose --filter="vtatest-qk-lpn" --force pyexps/vtatest.py --repo /home/kejr/qemu/shared/simbricks-lpn/
# sudo -E python3 run.py --verbose --filter="jpeg_decoder-qk-lpn" --force pyexps/jpeg_decoder.py --repo /home/kejr/qemu/shared/simbricks-lpn/
