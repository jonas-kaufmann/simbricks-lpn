...
source "qemu" "autogenerated_1" {
  ...
  iso_checksum     = "file:https://cloud-images.ubuntu.com/noble/20240912/SHA256SUMS"
  iso_url          = "https://cloud-images.ubuntu.com/noble/20240912/noble-server-cloudimg-amd64.img"
  memory           = "${var.memory}"
